...
export function Step2MachineDetails({
  ...
  return (
    <View style={{ gap: 32 }}>
      {/* Machine Type */}
      <View>
        <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 18, color: '#0d631b', marginBottom: 16 }}>Harvester Type <Text style={{ color: 'red' }}>*</Text></Text>
        <View style={{ flexDirection: 'row', gap: 16 }}>
          <TouchableOpacity activeOpacity={0.8} onPress={() => setMachineType('combine')} style={[{ flex: 1, padding: 24, borderRadius: 24, borderWidth: 2, alignItems: 'center' }, machineType === 'combine' ? { borderColor: '#0d631b', backgroundColor: 'rgba(163, 246, 156, 0.1)' } : { borderColor: 'transparent', backgroundColor: '#ffffff' }]}>
            ...
            <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 16, color: '#1a1c19' }}>Combine</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.8} onPress={() => setMachineType('tractor')} style={[{ flex: 1, padding: 24, borderRadius: 24, borderWidth: 2, alignItems: 'center' }, machineType === 'tractor' ? { borderColor: '#0d631b', backgroundColor: 'rgba(163, 246, 156, 0.1)' } : { borderColor: 'transparent', backgroundColor: '#ffffff' }]}>
            ...
            <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 16, color: '#1a1c19' }}>Tractor</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={{ gap: 24 }}>
        <View>
          <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 18, color: '#0d631b', marginBottom: 12 }}>Brand <Text style={{ color: 'red' }}>*</Text></Text>
          <View style={{ backgroundColor: '#e3e3de', borderRadius: 16, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16 }}>
            ...
            <TextInput value={brand} onChangeText={setBrand} placeholder="e.g. John Deere" placeholderTextColor="#707a6c" style={{ flex: 1, paddingVertical: 16, paddingHorizontal: 12, fontSize: 16, color: '#1a1c19' }} />
          </View>
        </View>
        <View>
          <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 18, color: '#0d631b', marginBottom: 12 }}>Year <Text style={{ color: 'red' }}>*</Text></Text>
          <View style={{ backgroundColor: '#e3e3de', borderRadius: 16, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16 }}>
            <MaterialIcons name="calendar-today" size={24} color="#707a6c" />
            <TextInput value={year} onChangeText={setYear} keyboardType="numeric" placeholder="2024" placeholderTextColor="#707a6c" style={{ flex: 1, paddingVertical: 16, paddingHorizontal: 12, fontSize: 16, color: '#1a1c19' }} />
          </View>
        </View>
      </View>
      ...
      <View style={{ height: 192, borderRadius: 32, overflow: 'hidden', marginVertical: 8 }}>
        ...
        <View style={{ position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(0,34,4,0.6)', padding: 24, paddingTop: 64 }}>
          <Text style={{ color: '#fff', fontFamily: 'headline', fontWeight: '600', fontSize: 18, fontStyle: 'italic' }}>"Premium equipment attracts premium rates."</Text>
        </View>
      </View>
      ...
      <View style={{ backgroundColor: '#f4f4ef', padding: 24, borderRadius: 32 }}>
        <View style={{ marginBottom: 24 }}>
          <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 20, color: '#0d631b', marginBottom: 16 }}>Pricing Model <Text style={{ color: 'red' }}>*</Text></Text>
          <View style={{ flexDirection: 'row', backgroundColor: '#e3e3de', padding: 6, borderRadius: 32 }}>
            <TouchableOpacity onPress={() => setPricingModel('per_acre')} style={[{ flex: 1, alignItems: 'center', paddingVertical: 10, borderRadius: 24 }, pricingModel === 'per_acre' ? { backgroundColor: '#0d631b', elevation: 2, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4 } : {}]}>
              <Text style={[{ fontWeight: 'bold' }, pricingModel === 'per_acre' ? { color: '#fff' } : { color: '#707a6c' }]}>Per Acre</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setPricingModel('per_hour')} style={[{ flex: 1, alignItems: 'center', paddingVertical: 10, borderRadius: 24 }, pricingModel === 'per_hour' ? { backgroundColor: '#0d631b', elevation: 2, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4 } : {}]}>
              <Text style={[{ fontWeight: 'bold' }, pricingModel === 'per_hour' ? { color: '#fff' } : { color: '#707a6c' }]}>Per Hour</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={{ backgroundColor: '#ffffff', borderRadius: 24, paddingVertical: 24, paddingHorizontal: 24, flexDirection: 'row', alignItems: 'center' }}>
          ...
          <Text style={{ fontFamily: 'headline', fontWeight: 'bold', fontSize: 20, color: '#40493d', textTransform: 'uppercase' }}>/ {pricingModel === 'per_acre' ? 'Acre' : 'Hour'}</Text>
        </View>

        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 16, gap: 8 }}>
          <MaterialIcons name="info" size={20} color="#835400" />
          <Text style={{ fontSize: 14, fontWeight: '500', color: '#40493d' }}>Average rate: <Text style={{ fontWeight: 'bold' }}>₹850 - ₹1,200</Text></Text>
        </View>
      </View>
    </View>
  );
