...
export function ConfirmEndWorkModal({ visible, onClose, onConfirm, isLoading }: ConfirmEndWorkModalProps) {
  return (
      ...
      <View style={StyleSheet.absoluteFill} className="justify-center items-center">
        ...
        >
          ...
          <Text className="text-base text-on-surface-variant font-body mb-10 leading-relaxed">
            Are you sure you have finished the work? This will mark the booking as completed and notify the farmer.
          </Text>
          ...
          <View className="flex-row gap-4">
            ...
            >
              {isLoading ? (
                ...
                <Text className="text-white font-black text-sm uppercase tracking-widest">End Work</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
